...
update-fastai: ## reminder to update fastai deps
	@echo "\n\n*** Reminder"
	@echo "If this was a bug fix or a change of API, update the following four `fastai` dependency files: `conda/meta.yaml`, `imports/core.py`, `setup.py` with this release's `fastprogress` version number."
