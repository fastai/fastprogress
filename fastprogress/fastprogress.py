# AUTOGENERATED! DO NOT EDIT! File to edit: dev/01_fastprogress.ipynb (unless otherwise specified).
...
class ProgressBar():
    ...
    def __init__(self, gen, total=None, display=True, leave=True, parent=None, master=None):
        self.gen,self.parent,self.master = gen,parent,master
